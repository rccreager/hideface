...
for recognizer_name, _ in recognizer_dict.items():
    for img_path in img_paths:
        ...
        image_labels = imagelabels.ImageLabels(img_path).add_all_labels(truth_file, recognizer_dict)
